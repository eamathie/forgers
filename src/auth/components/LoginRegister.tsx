...
const LoginRegister = ({ onClickOutside }: LoginRegisterProp) => {
    ...
    return (
        <div ref={ref} className="flex flex-col gap-1 bg-white rounded-lg outline outline-yellow-500 shadow-lg text-xs text-left p-3">
            {!user ?
            <div>
